...
load('mlpHC4_hest_001_2020-03-29.RData')
...
for (K in c(45000, 47500, 50000, 52500, 55000)){
  ...
  #min(r2min)
  write.csv(price_error, file = paste('mlp_HC4_hest_price_error_table_001_',K,'_', Sys.Date(), '.csv', sep = '')) 
  
  save(MLPPriceError, file = paste('mlp_HC4_hest_price_error_001_',K,'_', Sys.Date(), '.RData', sep = ''))
}
...
write.csv(round(tab_III,4), file = paste('tab_III_hest_HC4_', Sys.Date(),'.csv', sep = ''))
...
#View(tab_IV)
write.csv(tab_IV, file = paste('tab_IV_hest_HC4_', Sys.Date(),'.csv', sep = ''))
...
#View(tab_V)
write.csv(tab_V, file = paste('tab_V_hest_HC4_', TimeToExpiry, "_", Sys.Date(),'.csv', sep = ''))
...
#View(tab_V_Imp)
write.csv(tab_V_Imp, file = paste('tab_V_Imp_hest_HC4_', TimeToExpiry, "_", Sys.Date(),'.csv', sep = ''))
...
#View(tab_VI)
write.csv(tab_VI, file = paste('tab_VI_Hest_HC4_', TimeToExpiry, "_", Sys.Date(),'.csv', sep = ''))
