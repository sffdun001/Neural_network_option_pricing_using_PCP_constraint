...
load('mlpHC3_market_final_2020-09-09.RData')
...
write.csv(t1, file = paste('mlpHC3_market_price_error_', Sys.Date(), '.csv', sep = ''))
...
row.names(t1) = c('AIH8','AIM8','AIU8','AIZ8','AIH9','AIM9','Train','AIU9/Test')
row.names(t2) = c('AIH8','AIM8','AIU8','AIZ8','AIH9','AIM9','Train','AIU9/Test')
write.csv(t1, file = paste('tab_V_HC3_Market_', Sys.Date(),'.csv', sep = ''))
write.csv(t2, file = paste('tab_V_HC3_Imp_Market_', Sys.Date(),'.csv', sep = ''))
...
write.csv(t1, file = paste('tab_VI_HC3_Market_', Sys.Date(),'.csv', sep = ''))
